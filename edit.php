...
<body>
    ...
    ?>
        <div class="container mt-5">
            <p><a href="main.php">Home</a>/ Edit buku / <?php echo $data['nama_buku'] ?></p>
            <div class="card">
                ...
                <div class="card-body fw-bold">
                    ...
                    <form method="post" action="update.php">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nama" placeholder="Masukkan Nama Anda" name="nama" value="<?php echo $data['nama_buku']; ?>">
                        </div>
                        <!-- input nim -->
                        <div class="mb-3">
                            <label for="NIM" class="form-label">Kategori Buku</label>
                            <input type="text" class="form-control" id="NIM" placeholder="Masukkan NIM Anda" name="kategori" value="<?php echo $data['kategori_buku']; ?>">
                        </div>
                        <!-- input alamat -->
                        <div class="mb-3">
